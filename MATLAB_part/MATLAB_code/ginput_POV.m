function ginput_POV(arg1,az_min,ra_min,azimuth_pixel,range_pixel,e_samp,lim_e_min,lim_e_max,num_pix_a,num_pix_r,angle)
...
if ~strcmp(tp,'none') && ~strcmp(tp,'x') && ~strcmp(tp,'micro'),
   ...
   % Additional part (compared to default ginput.m) starts here!!!
   ...
   % 2.) Initiate elevation plots
   
   % ----------------------------------------
   
   Tomo(az_int_min,az_int_max,ra_int_min,ra_int_max,e_samp,lim_e_min,lim_e_max,angle);
