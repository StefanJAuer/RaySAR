...
class Trace
{
	...
	protected: // TODO FIXME - should be private
		...
		// RaySAR extension, shared pointer to the contribution writer singleton
		boost::shared_ptr<raysar::RefContribWriter> refWriter;

		// RaySAR extension, thread-local scene properties
		DBL Intensity_Radar;
		DBL Distance_Radar;
		DBL Azimuth_Initial;
		DBL Elevation_Initial;
		DBL Reflectivity_Bounce;
